...
# Aufruf:   docker build --tag juergenzimmermann/pc:2025.10.1-trixie .
#               ggf. --progress=plain
#               ggf. --no-cache
...
#           docker save juergenzimmermann/pc:2025.10.1-trixie > pc.tar
#           docker network ls
...
LABEL org.opencontainers.image.title="pc" \
  org.opencontainers.image.description="Appserver pc mit Basis-Image Debian Trixie" \
